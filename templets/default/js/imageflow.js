...
function ImageFlow() {
    ...
    this.defaults =
	{
	    animationSpeed: 50,             /* 动画速度 */
	    aspectRatio: 2.3,          /* 图像流容器(宽度除以高度)的纵横比) */
	    buttons: false,          /* 切换导航按钮 */
	    captions: true,           /* Toggle 字幕 */
	    circular: true,          /* Toggle 圆形旋转 */
	    imageCursor: 'pointer',      /* Cursor type for all images - default is 'default' */
	    ImageFlowID: 'imageflow',    /* Default id of the ImageFlow container */
	    imageFocusM: 1.0,            /* 为聚焦的图像大小增加了1.0的乘法*/
	    imageFocusMax: 3,              /* 左右二侧图片数量 */
	    imagePath: '',             /* Path to the images relative to the reflect_.php script */
	    imageScaling: true,           /* Toggle图像缩放 */
	    ...
	    slideshowAutoplay: true,          /* Toggle 切换自动幻灯片在启动 */
	    startID: 1,              /* Image ID to begin with */
	    glideToStartID: true,           /* Toggle glide animation to start ID */
	    startAnimation: false,          /* 动画在启动时从右边移动*/
	    xStep: 120             /*在px的x轴上的步长 */
	};
