...
$cfg_cmspath = '/dedegls';
$cfg_cookie_encode = 'dM52hpHA03L68BCAgn1GaeQE35bMPbG';
$cfg_indexurl = '/dedegls';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = ' 北京格兰斯门窗有限公司 ';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright @ 2012-2017 glsmc Corporation,All Rights Reserved 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'Y';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '北京格兰斯门窗有限公司';
$cfg_description = '北京格兰斯门窗有限公司专业生产，铝包木门窗、木包铝门窗、实木门窗、铝包木阳光房、高档铝包木门窗、铝包木金钢网一体窗、德式铝包木门窗，别墅铝包木门窗扩建及铝包木窗户保养等。顶尖设计，大师之作，德国工艺、厂家直销、全国配送、5年质保、进口木材五金和贴心售后。

本公司始建于2006年2月，是国家（北京市）门窗（幕墙）行业协会副会长单位，是北京市（幕墙）定点生产企业铝包木门窗品牌。本公司曾被全国工商联五金机电商会建筑五金门窗（幕墙）委员会授予“新型创新企业”荣誉称号及“节能环保诚信品牌”产品称号。';
$cfg_beian = ' 京ICP备12014077号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
